...
namespace Samplerax.NINA.OatSafeTimeSync.OatSafeTimeSyncDrivers {
    /// <summary>
    ...
    public class OatSafeTimeSyncWeatherProvider : IEquipmentProvider<IWeatherData> {
        private IProfileService profileService;

        [ImportingConstructor]
        public OatSafeTimeSyncWeatherProvider(IProfileService profileService) {
            this.profileService = profileService;
        }

        public string Name => "OatSafeTimeSync";

        public IList<IWeatherData> GetEquipment() {
            var devices = new List<IWeatherData>();
            devices.Add(new OatSafeTimeSyncWeatherDriver("MyUniqueId", "MyDeviceId"));
