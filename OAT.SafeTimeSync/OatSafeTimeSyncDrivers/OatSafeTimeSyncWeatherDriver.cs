...
namespace Samplerax.NINA.OatSafeTimeSync.OatSafeTimeSyncDrivers {
    ...
    /// </summary>
    public class OatSafeTimeSyncWeatherDriver : BaseINPC, IWeatherData {
        public OatSafeTimeSyncWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"OatSafeTimeSync Weather Data ({deviceId})";
        ...
        public string Category => "OatSafeTimeSync Weather Driver";
